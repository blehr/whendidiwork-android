...
import com.brandonlehr.whendidiwork.CalendarListFragment.OnListFragmentInteractionListener;
...
public class MyCalendarRecyclerViewAdapter extends RecyclerView.Adapter<MyCalendarRecyclerViewAdapter.ViewHolder> {
    ...
    public MyCalendarRecyclerViewAdapter(List<Calendar> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mIdView.setText(mValues.get(position).getSummary());
